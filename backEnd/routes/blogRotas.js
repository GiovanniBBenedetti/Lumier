...
import {
  obterRecomendacaoPorIdController,
  obterRecomendacaoPorEmailController,
  atualizarRecomendacaoController,
  criarRecomendacaoController,
  obterRecomendacaoController,
  criarBlogController,
  atualizarBlogController,
  excluirBlogController,
  listarBlogController,
  obterBlogPorIdController,
  obterBlogPorEmailController
...
router.get('/recomendacao/:email', authMiddleware, obterRecomendacaoPorEmailController);
...
router.get('/email/:email', obterBlogPorEmailController); 
...
router.delete('/:id', excluirBlogController);
