    ...
    <div className={`${poppins.className} usuario-container`}>
      ...
      <div className="usuario-card shadow-lg">
        ...
        <div className="usuario-info">
          ...
          <div className="usuario-item">
            <i className="bi bi-shield-lock-fill me-2"></i> <strong>Turma: </strong> {usuario.turma}
          </div>
        </div>
          ...
          {recomendacoes.length > 0 ? (
            recomendacoes.map((noticia) => (
              <div className="col-12 col-md-4 mt-3" key={noticia.id}>
                <div className="card usuario h-100">
                  <img
                  ...
                  <div className="card-body">
                    <h5 className="card-title tituloCardUsuario">{noticia.titulo}</h5>
                    <p className="card-text">{noticia.conteudo}</p>
                    <p data-estado={noticia.estado} className="estado-final">Estado:</p>
                  </div>
                </div>
              </div>
